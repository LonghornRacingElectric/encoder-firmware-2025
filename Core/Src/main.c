...
int main(void) {
    ...
    while (1) {
        ...
        // // usb_printf("apps1 %f\n", apps1); // works just like printf, use
        // like
        // // printf float bpps1 = adc_getBpps1() / 3.3f; usb_printf("bpps1
        // %f\n",
        // // bpps1); // works just like printf, use like printf float sin =
        // // adc_getSin_N() ;// / 3.3f - 0.5f;
        ...
        // //
        // //  // Map the cosine value to a wider range for more visible color
        // //  changes float amplified_cos = cos * 3.5f;  // Amplify small
        // changes float red = fabs(cos);  // Use absolute value to keep red
        // positive

        // // Make green more responsive to small changes in cos
        // float green =
        //     1.0f + sin(cos * M_PI);  // Varies between 0-2 based on cos

        // // Add blue component that varies differently than red and green
        // float blue =
        //     2.0f - fmod(cos * 5.0f, 2.0f);  // Creates a different pattern

        // // // Print debug info
        // // usb_printf("cos: %0.3f, amplified: %0.3f\n",
        // //            cos, amplified_cos);

        // //     // Constrain values to valid LED range (typically 0-1 or 0-255
        ...
        // // usb_printf("apps2 %f\n", apps2); // works just like printf, use
        // like
        // // printf

        // // float bpps1 = adc_getBpps1() / 3.3f;
        // // usb_printf("bpps1 %f\n", bpps1); // works just like printf, use
        // like
        // // printf
        // //
        // // float bpps2 = adc_getBpps2() / 3.3f;
        // // usb_printf("bpps2 %f\n", bpps2); // works just like printf, use
        // like
        // // printf
